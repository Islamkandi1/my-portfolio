            ...
            {projects.map((project, index) => (
              ...
              >
                <section className="relative overflow-hidden h-56">
                  ...
                  />
                  <section className="absolute inset-0 bg-linear-to-t from-black/80 via-black/40 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500 flex items-end justify-center pb-4">
                    <a
                      href={project.link}
                      target="_blank"
